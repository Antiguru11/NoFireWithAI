...
import pandas as pd
import numpy as np
from competition.metro import helpers
...
def make_train(path, array_of_lons, array_of_lats, step, start_date):
    ...
    print('load_and_prepare_targets')
    ...
    print('make_and_prepare_grid_df')
    ...
    print('Убираем ячейки не из России')
